 ...
 * @param  {AcquireTokenCallback}   callback
 */
TokenRequest.prototype.getTokenWithCertificate = function(certificate, thumbprint, callback, authorizationCode) {
  ...
  var oauthParameters = null;
  
  if(authorizationCode != undefined) {
    oauthParameters = this._createOAuthParameters(OAuth2GrantType.JWT_BEARER_USER);
    oauthParameters[OAuth2Parameters.ASSERTION] = authorizationCode;    
    oauthParameters[OAuth2Parameters.CLIENT_ASSERTION_TYPE] = OAuth2GrantType.JWT_BEARER;
    oauthParameters[OAuth2Parameters.REQUESTED_TOKEN_USE] = OAuth2GrantType.ON_BEHALF_OF;
    oauthParameters[OAuth2Parameters.CLIENT_ASSERTION] = jwt;    
  } else {
    oauthParameters = this._createOAuthParameters(OAuth2GrantType.CLIENT_CREDENTIALS);
    oauthParameters[OAuth2Parameters.CLIENT_ASSERTION_TYPE] = OAuth2GrantType.JWT_BEARER;
    oauthParameters[OAuth2Parameters.CLIENT_ASSERTION] = jwt;
  }
